 ...
 */
contract NFTUpgradeable is OwnableUpgradeable, ERC165StorageUpgradeable, IERC1155Upgradeable {
...
//        setProxyApproval(msg.sender, true);
    ...
    function isHolder(address account, uint256 id, uint256 amount) public view virtual returns (bool) {
        return balanceOf(account, id) >= amount;
    }
