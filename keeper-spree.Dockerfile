...
COPY --from=deploy /nevermined-contracts/artifacts2 /nevermined-contracts/artifacts
COPY --from=deploy /nevermined-contracts/circuits2 /nevermined-contracts/circuits
