...
contract('NFT Sales with Access Proof Template integration test', (accounts) => {
    ...
    async function prepareAgreement({
        ...
        const conditionIdEscrow = await escrowCondition.hashValuesMulti(did, amounts, receivers, escrowCondition.address, token.address, fullIdLockPayment, [fullIdTransferNFT, fullIdAccess])
