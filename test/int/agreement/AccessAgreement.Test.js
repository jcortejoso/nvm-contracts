    ...
    describe('create and fulfill escrow agreement', () => {
        ...
        it('should create escrow agreement and abort after timeout', async () => {
            ...
            await assert.isRejected(
                escrowPaymentCondition.fulfill(agreementId, did, escrowAmounts, receivers, escrowPaymentCondition.address, token.address, conditionIds[1], conditionIds[0], { from: receiver })
            )
